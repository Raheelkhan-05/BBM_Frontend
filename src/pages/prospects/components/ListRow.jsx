  ...
  const ListRow = React.memo(function ListRow({
    ...
    // Prospect-stage records (no active enquiries yet) get a green avatar,
    // but only in the "all" (Tasks) view where showContactRow is true —
    // that's the tab where prospect vs lead stage actually matters visually.
    const isProspectStage = showContactRow && !isLead;

    const avatarBg = isProspectStage
