      ...
      <Sheet>
        ...
        <form onSubmit={submit} className="px-5 py-4 space-y-3">
          <div>
            ...
            <input value={form.party_name} onChange={e => set("party_name", e.target.value)} className={inp()} />
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input type="number" value={form.bill_amount} onChange={e => set("bill_amount", e.target.value)} className={inp()} />
            </div>
            <div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <Lbl>Mobile-1</Lbl>
              <input value={form.mobile_1} onChange={e => set("mobile_1", e.target.value)} className={inp()} />
            </div>
            <div>
              <Lbl>Mobile-2</Lbl>
              <input value={form.mobile_2} onChange={e => set("mobile_2", e.target.value)} className={inp()} />
            </div>
          </div>
